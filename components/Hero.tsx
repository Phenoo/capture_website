...
export default function Hero({ home }: any) {
  const item = {
    background:
      "https://res.cloudinary.com/dnir0cslk/image/upload/v1708504257/Home_Page_01_ayf9jv.jpg",
    title:
      home[0].herotext || "Your partner in design & commercial transformations",
    description: `Uniquely Designed Spaces For Your Business`,
  };
