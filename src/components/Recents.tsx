         ...
         <div className='mt-4 space-y-4'>
             <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3'>
                 <div className='relative h-72  w-full '>
                     ...
                     <div className=' bg-black/50 hover:bg-black/20 transition-all cursor-pointer absolute top-0 w-full h-full justify-center items-end py-4 flex text-white text-sm md:text-lg'>
                         <h4>
                 ...
                 <div className='relative h-72  w-full'>
                     ...
                     <div className=' bg-black/50 hover:bg-black/20 transition-all cursor-pointer absolute top-0 w-full h-full justify-center py-4 items-end flex text-white text-sm md:text-lg '>
                         <h4>
